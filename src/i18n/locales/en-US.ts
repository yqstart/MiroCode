...
export const enUS = {
  ...
  settings: {
    ...
    ai: {
      ...
      enabled: "Enable AI inline completion",
      enabledDesc: "Automatically request AI completions (ghost text) while typing. Press Tab to accept. Requires provider and API Key.",
      provider: "Provider",
      apiKey: "API Key",
      ...
      multiline: "Multiline",
      multilineAuto: "Auto",
      multilineAlways: "Always",
      multilineNever: "Never",
      testConnection: "Test Connection",
      testing: "Testing…",
      testSuccess: "Connection successful",
      testFailed: "Connection failed",
      keyNotSet: "Please set API Key first",
    },
  },
  explorer: {
    title: "Explorer",
  ...
  sessions: {
    ...
    hostKeyUnknownConfirm:
      "Unknown host key. Trust and continue?\n\nHost: {endpoint}\nFingerprint: {fingerprint}\n\nTrusted keys are saved to ~/.mirocode/known_hosts",
  ...
  sftp: {
    ...
    selectDownload: "Choose save location",
    uploaded: "Uploaded {count} file(s)",
    downloaded: "Downloaded {name}",
    download: "Download",
    downloading: "Downloading…",
    edit: "Edit",
    notEditable: "Not editable here; downloading instead",
    hint: "Double-click folder to open · file to edit · right-click for more",
    ...
    invalidName: "Name cannot contain path separators or ..",
  },
  packageScripts: {
    title: "Scripts",
  ...
  lsp: {
    ...
    enabledDesc: "Provides type diagnostics, smart completion, go-to-definition, references and rename for TS/JS/Vue. Install per-language with bundled Node runtime - no host Node required",
    runtimeNoNode: "⚠ Node.js not detected. Install Node and restart to enable LSP",
    runtimeNoServer: "⚠ Node detected but language servers not installed. Install from the list below",
    ...
    bundleReady: "✓ Language services ready",
    bundleDesc: "Choose the language services you need. Each includes a Node runtime and installs independently",
    install: "Install",
    update: "Update",
    uninstall: "Uninstall",
    ...
    installHint: "Install latest version v{version}",
    offlineHint: "Cannot fetch version info (offline or mirrors unreachable). Retry when back online",
    updateAvailable: "New version v{version} available",
    latestVersion: "Up to date",
    installFailed: "Language service install failed: {message}",
    installed: "Language services installed (v{version})",
    uninstallFailed: "Language service uninstall failed: {message}",
    uninstalled: "Language services uninstalled",
    mirror: "Download mirror",
    mirrorDesc: "Use a mirror for mainland China networks; auto tries official first, falls back automatically",
    mirrorAuto: "Auto (Official -> Mirror)",
    mirrorGithub: "GitHub Official",
    mirrorGhproxy: "Accelerated (ghfast.top)",
    mirrorCustom: "Custom",
    customBase: "Custom mirror URL",
    customBasePlaceholder: "https://… (same directory layout as official)",
    phaseManifest: "Fetching version info…",
    phaseDownload: "Downloading",
    phaseVerify: "Verifying integrity…",
    phaseExtract: "Extracting…",
    phaseDone: "Done",
    // Language service list items
    lsTypeScript: "TypeScript Language Server",
    lsTypeScriptDesc: "Diagnostics · Completion · Jump",
    lsVue: "Vue Language Server",
    lsVueDesc: "Template/script/style intelligence",
    lsBadgeInstalled: "Installed",
    lsBadgeNotInstalled: "Not installed",
    lsBadgeUpdate: "Update available",
    lsUninstallAll: "Uninstall all",
    // Mirror connectivity
    mirrorOkGithub: "Official reachable",
    mirrorOkGhproxy: "Mirror reachable",
    mirrorOkCustom: "Custom reachable",
    mirrorFail: "Mirror unreachable, try another",
    mirrorChecking: "Checking…",
    // Vue file hint
    vueFileHint: "Vue file detected. Install language services for completion and diagnostics",
    statusClickHint: "Click to manage language services",
  },
} as const;
