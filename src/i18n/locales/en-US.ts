...
export const enUS = {
  ...
  lsp: {
    ...
    // Built-in language service bundle
    bundleReady: "✓ Built-in language services ready",
    bundleDesc: "Built-in TS/Vue language services (with Node runtime) can be installed to the app data directory in one click — no host Node required, keeping the installer lightweight",
    install: "Install",
    update: "Update",
    uninstall: "Uninstall",
    installedTag: "Installed",
    installedVersion: "Installed v{version}",
    notInstalled: "Built-in language services not installed",
